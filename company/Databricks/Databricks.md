...
## 公司简介
Databricks 从 Apache Spark / UC Berkeley AMPLab 系谱发展为 Lakehouse 与数据/AI 平台公司，现覆盖数据工程、训练、模型治理与 Mosaic AI 等生成式 AI 能力。它是 Berkeley systems 从研究到大规模商业基础设施的另一条经典路径。
