...
当前：[[清程极智]] 联合创始人，负责并行训练、推理框架、算子优化等研发；[[community/thu-pacman/Chitu/Chitu|赤兔（Chitu）]] 推理引擎核心负责人。

## 教育与技术经历
- [[清华大学]]：计算机专业学士、博士；[[company/清程极智/翟季冬 Jidong Zhai|翟季冬]] 课题组博士毕业生。
- 研究方向包括编程语言、异构计算；代表工作包括 FreeTensor。
- [[清程极智]]：负责赤兔（Chitu）推理引擎及并行训练/推理系统、算子优化，在多种异构国产算力上做 LLM inference 优化。
...
- [[company/清程极智/师天麾 Tianhui Shi|师天麾（Tianhui Shi）]]：**清华 HPC 同门 + 清程极智联合创始人**。两人同属翟季冬团队并于 2024 左右从清华博士阶段进入 QingCheng.AI；当前分别覆盖赤兔/算子优化与更广的训练推理基础设施。
- [[company/清程极智/汤雄超 Xiongchao Tang|汤雄超（Xiongchao Tang）]]：**清程极智联合创始团队**。公开资料确认共同推进训练—推理系统软件与国产异构算力适配；首次直接协作月份未公开。
