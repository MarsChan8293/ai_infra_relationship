...
relations:
  ...
  - '{"target":"company/Inferact/Ion Stoica","type":["advisor","research-collaboration"],"end":"2025","confidence":"high","evidence":["https://www2.eecs.berkeley.edu/Pubs/Dissertations/Faculty/stoica.html","https://www2.eecs.berkeley.edu/Pubs/TechRpts/2025/EECS-2025-194.html"]}'
  - '{"target":"community/vllm-project/vLLM/游凯超 Kaichao You","type":["cofounder","coworker","open-source-collaboration"],"project":"vLLM","company":"Inferact","confidence":"high","evidence":["https://woosuk.me/","https://inferact.ai/","https://vllm.ai/events/vllm-conference/2026"]}'
  - '{"target":"community/vllm-project/vLLM/Simon Mo","type":["cofounder","coworker","open-source-collaboration"],"project":"vLLM","company":"Inferact","confidence":"high","evidence":["https://inferact.ai/","https://docs.vllm.ai/en/latest/governance/process/","https://vllm.ai/events/vllm-conference/2026"]}'
...
## 简介
vLLM 创始人、PagedAttention 与早期 engine core 的主要设计者之一，当前是 [[Inferact]] 联合创始人兼 CTO，也是 [[vLLM]] Lead Maintainer。

## 教育经历
- Seoul National University：计算机科学与工程、数学双学士
- [[UC Berkeley]]：计算机博士，2021-08–2025-12；导师 [[Ion Stoica]]

## 工作经历
- [[Google|Google DeepMind]]：Research Scientist，2024-03–2025-05
- Thinking Machines Lab：Member of Technical Staff，2025-05–2025-11。当前仓库尚未把该 lab 单独实体化，因此暂不保留悬空双链。
- [[Inferact]]：联合创始人、CTO，2025-11–至今

## 社区贡献
- [[vLLM]] 创始人；2023 起推动项目与 PagedAttention / engine core
- PagedAttention、engine core、speculative decoding、attention 等核心方向

## 人物关系
- [[company/Inferact/Ion Stoica|Ion Stoica]]：**UC Berkeley 博士导师**。Berkeley dissertation 目录与 Woosuk 2025 dissertation 均确认 Ion 为其博士导师，因此结构化为 `advisor`，而不是把师生关系降格成 same-lab / mentor-network。
- [[community/vllm-project/vLLM/李卓翰 Zhuohan Li|李卓翰（Zhuohan Li）]]：**UC Berkeley 同实验室研究者 + vLLM 共同创始/共同维护者**。李卓翰 2019–2024、Woosuk 2021–2025 在 UC Berkeley CS 博士阶段有 2021–2024 的学术重叠，两人都在 [[Ion Stoica]] 系统研究网络；2023 共同创建 / 推动 [[vLLM]]。李卓翰 2024 后进入 OpenAI、后 Meta，因此当前不是同事。
- [[community/vllm-project/vLLM/Simon Mo|Simon Mo]]：**Berkeley 系统研究合作者 + vLLM 社区共同领导者 + Inferact 联合创始人**。2023–2025 共同建设 vLLM；2025–至今在 [[Inferact]] 共事，Simon 任 CEO、Woosuk 任 CTO。
