...
## 人物关系
- [[Inferact/Woosuk Kwon|Woosuk Kwon]]：**UC Berkeley 博士导师 / 学生 + vLLM 研究网络**。Woosuk 2021–2025 在 Berkeley CS 博士阶段由 Ion Stoica 指导，博士论文主题为 vLLM / efficient LLM inference；此后两人又同属 Inferact founding network。
- [[community/vllm-project/vLLM/李卓翰 Zhuohan Li|李卓翰（Zhuohan Li）]]：**UC Berkeley 博士导师 / 学生 + vLLM 研究网络**。李卓翰 2019–2024 在 Berkeley 博士阶段由 Ion Stoica 指导，是 vLLM 共同创建者之一。
- [[community/vllm-project/vLLM/Simon Mo|Simon Mo]]：**UC Berkeley 博士共同导师 / 学生 + Inferact founding network**。Simon 2026 博士论文《Building Open Source Inference Serving Systems》由 Ion Stoica 与 [[Inferact/Joseph Gonzalez|Joseph Gonzalez]] 共同指导；三人随后处于 Inferact / vLLM 创始与 serving systems 网络。
...
- [[community/vllm-project/vLLM/游凯超 Kaichao You|游凯超（Kaichao You）]]：**Berkeley Sky 技术环境 + Inferact founding network**。游凯超 2024 在 UC Berkeley Sky Lab 访问，Ion 是 Sky Lab Director；2026 Inferact 官方 launch 将两人都列入 founding members。公开资料不足以写成正式导师关系。
