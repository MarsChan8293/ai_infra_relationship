...
relations:
  ...
  - '{"target":"community/sgl-project/SGLang/郑连民 Lianmin Zheng","type":["student","paper-coauthor","research-collaboration"],"project":"SGLang","end":"2024","confidence":"high","evidence":["https://www2.eecs.berkeley.edu/Pubs/TechRpts/2024/31234.html","https://www2.eecs.berkeley.edu/Pubs/Dissertations/Faculty/jegonzal.html","https://arxiv.org/abs/2312.07104"]}'
...
- [[community/sgl-project/SGLang/郑连民 Lianmin Zheng|郑连民（Lianmin Zheng）]]：**UC Berkeley 博士导师 / 学生**。郑连民 Berkeley 博士阶段由 Joseph Gonzalez 与 Ion Stoica 指导；其系统工作从 Alpa、FastChat 延伸到 [[SGLang]]。这里已从泛化 `mentor-network` 升级为正式 `student` 强边。
