...
## 项目简介
FlagScale 是 FlagOS 的大模型训练/推理框架主线，面向多种 AI 芯片提供模型开发、分布式训练、推理部署与自动调优能力。对本仓库最重要的连接是“多芯片 + 自动并行/调优 + inference deployment”，因此它是智源侧与推理优化最直接的系统节点之一。

## GitHub
https://github.com/flagos-ai/FlagScale

## 主要维护者 / 组织
官方 `MAINTAINERS.md` 当前列出 `zhaoyinglia`、`ceci3`、`aoyulong`、`heavyrain-lzy`、`caozhou1995`。其中公开资料可确认 [[赵英利 Yingli Zhao]]、[[敖玉龙 Yulong Ao]]、[[曹州]] 与对应项目角色；其余 handle 不据此猜真实身份。

## 生态关系
[[FlagOS]] · [[FlagGems]] · [[FlagCX]] · [[FlagTree]] · [[vllm-plugin-FL]] · [[sglang-plugin-FL]] · [[vLLM]] · [[SGLang]]。这些链接表示项目级技术栈或适配关系，不自动推断维护者之间为公司同事。
