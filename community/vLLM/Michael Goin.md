...
- [[vLLM/游凯超 Kaichao You|游凯超（Kaichao You）]]：**vLLM Project Lead + compile / hardware-plugin 跨公司技术协作**。2025 Hardware Plugin 工作中两人与 Simon Mo、Robert Shaw 等共同参与 refactor、deep discussion 与 review；2025-08 又共同署名 vLLM 官方 torch.compile 技术文章。两人分属 Red Hat 与 [[Inferact]]，不标记为同事。
