...
- [[community/llm-d/Maroon Ayoub|Maroon Ayoub]]：**Red Hat inference engineering 同事 + llm-d disaggregation 邻接协作**。2025 KV-cache routing 工作已有共同作者网络；2026 Maroon 转入 Red Hat 后，两人分别覆盖 KV-disaggregation / agentic serving 与 PD-disaggregation。具体直属关系未公开。
