...
## 当前关系
- [[IBM]]：截至 2026-09，llm-d 官方作者页列为 Distinguished Engineer, IBM。
...
## 技术方向
Kubernetes-native distributed inference、跨 accelerator serving、production well-lit paths 与项目级架构治理。2026-07 仍参与 llm-d agentic serving 路线的公开技术文章，说明其关系不是一次性的 founding credit。
