...
relations:
  ...
  - '{"target":"community/vllm-project/vLLM/Tyler Michael Smith","type":["coworker","technical-collaboration"],"project":"llm-d","company":"Red Hat","start":"2026","confidence":"high","evidence":["https://llm-d.ai/blog/serving-glm-5-2-agentic-workloads-on-llm-d","https://llm-d.ai/blog/kv-cache-wins"]}'
---
# Maroon Ayoub

## 当前关系
- [[Red Hat]]：2026-06 与 2026-07 的 llm-d 官方技术文章均列为 Senior Principal Machine Learning Engineer, Red Hat。
- IBM Research：历史研究网络。IBM Research 人物页仍列其为 Research Scientist & Architect，但时间晚于该档案的 llm-d 官方文章已明确其当前任职为 Red Hat，因此不再保留为 `current_affiliations`。
...
- [[community/vllm-project/vLLM/Tyler Michael Smith|Tyler Michael Smith]]：**Red Hat inference engineering 同事 + llm-d disaggregation / agentic-serving 技术协作者**。两人共同署名 2025 KV-cache routing 工作与 2026 GLM-5.2 agentic serving 工作；Tyler 同时是 [[vLLM]] Project Lead 和 llm-d PD-Disaggregation SIG Lead，因此这条边连接 vLLM 与 llm-d 两个推理核心生态。
...
- https://llm-d.ai/blog/kv-cache-wins
