...
- University of Washington：博士，导师 [[community/flashinfer-ai/FlashInfer/陈天奇 Tianqi Chen|陈天奇（Tianqi Chen）]]
...
## 人物关系
- [[community/flashinfer-ai/FlashInfer/陈天奇 Tianqi Chen|陈天奇（Tianqi Chen）]]：**博士导师 ↔ 学生 + 系统研究合作者**。叶子豪在 University of Washington 博士阶段由陈天奇指导；研究路径从 TVM/compiler 延伸到 FlashInfer 等 GPU inference systems。具体博士指导起止月份以学校/个人 CV 为准，本页不额外猜测。
- [[community/flashinfer-ai/FlashInfer/Jingfan Sun|Jingfan Sun]]：**NVIDIA 同事 + FlashInfer Full Codebase Approver 同僚**。截至 2026-09 两人均公开关联 NVIDIA，并拥有 FlashInfer 全代码库审批权限；叶子豪偏 creator/compiler/kernel 架构，Jingfan Sun 偏 GPU kernel、MoE/EP 与系统工程。首次在 NVIDIA 共事月份公开未确认。
