...
## 图谱中的连接
- [[Stanford University]]：博士阶段学术背景。
- [[Red Hat]]：2025-07–至今，Machine Learning Engineer。
- [[vLLM]]：Maintainer，主要连接高性能计算、GPU inference 与 serving engine 优化。
- [[Michael Goin]]、[[Lucas Wilkinson]]、[[Tyler Michael Smith]]：同属 Red Hat / vLLM inference engineering 网络；具体协作按各人物页的公开证据分别记录，不仅凭同公司自动推断直属关系。
