...
- [[community/llm-d/llm-d/Carlos Costa|Carlos Costa]]：**llm-d 跨公司项目领导协作；2025–至今**。Robert 属 Red Hat、Carlos 属 IBM，从项目发布到多个主要版本持续共同署名 distributed inference / well-lit paths 路线。
- [[community/llm-d/llm-d/Clayton Coleman|Clayton Coleman]]：**llm-d founding / release 协作；2025–至少 2026 可核验**。分别来自 Red Hat 与 Google；Clayton 当前活跃状态按其人物页的 leave/inactive 说明处理。
