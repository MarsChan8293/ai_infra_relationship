...
- [[community/llm-d/llm-d/Maroon Ayoub|Maroon Ayoub]]：**候选 llm-d / Red Hat 关联，暂缓结构化**。两人分别覆盖 KV-disaggregation / agentic serving 与 PD-disaggregation；存在项目邻接，但当前证据不足以证明可单独归因的直接人物协作。
