...
- [[vLLM/Simon Mo|Simon Mo]]：**Inferact 同事 + vLLM 共同维护者**。截至 2026-09 同属 Inferact；Simon 偏 API / serving / governance，Nick 偏 scheduler / distributed / KV Connector。
- [[vLLM/Robert Shaw|Robert Shaw]]：**vLLM distributed / disaggregated serving 开源协作者**。截至 2026-09 两人分属 Inferact 与 [[Red Hat]]；在 engine core、distributed、disaggregated serving 与 KV Connector 的维护边界有持续交叉，因此当前不标记为同事。
- [[TensorMesh/杜昆泰 Kuntai Du|杜昆泰（Kuntai Du）]]：**vLLM KV Connector / LMCache 跨公司协作者**。截至 2026-09 Nick 属 Inferact、杜昆泰属 [[TensorMesh]]；两人在 KV Connector、cache integration、offloading / distributed serving 方向形成模块级协作。
