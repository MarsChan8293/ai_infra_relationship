...
- [[Red Hat]]：AI / inference engineering leadership；Neural Magic 于 2025 年初并入 Red Hat 后继续负责 vLLM / inference 方向

## 社区贡献
vLLM Lead Maintainer，负责 engine core、distributed、disaggregated serving、KV Connector 与 observability。

## 人物关系
- [[Tyler Michael Smith]]：**前 Neural Magic、现 Red Hat 同事 + vLLM 共同维护者**。至少在 2025-02，Red Hat 官方将两人共同列为 DeepSeek MLA / FP8 优化贡献团队；截至 2026-09 两人仍共同参与 vLLM / large-scale inference，Robert 偏 engine/disaggregated serving，Tyler 偏 kernels/collectives/distributed。
- [[Michael Goin]]：**前 Neural Magic、现 Red Hat 同事 + vLLM 共同维护者**。2025-02 Red Hat 官方 DeepSeek 优化工作中与 Robert 同属贡献团队；Michael 偏 quantization / kernels / performance，Robert 偏 engine core / distributed。
