...
| 2 | VERIFY | history_followup | [[community/Ascend/msModelSlim/msModelSlim\|msModelSlim]] | project | maintainers | person | bridge | 9.271 | unresolved | coverage 0/4；source type Project；infra: serving/inference, moe, quantization；opens underrepresented target types |
...
| 4 | DISCOVER | bridge | [[community/xLLM-AI/xLLM/xLLM\|xLLM]] | project | maintainers | person | bridge | 9.250 | new | coverage 0/4；source type Project；infra: serving/inference, kv-cache, scheduler；opens underrepresented target types |
