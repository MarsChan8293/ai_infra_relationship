...
- Candidate actions: 1428
- Eligible actions: 1417
...
| 5 | [[university/清华大学/Zan Zong|Zan Zong]] | person | project_contribution | project, community | exploration | 8.344 | new | coverage 0/3；source type Person；infra: serving/inference, scheduler, distributed；opens underrepresented target types |
| 6 | [[company/Intel/Intel|Intel]] | company | projects | project, community, team | exploration | 8.266 | new | coverage 0/3；source type Company；infra: serving/inference, kv-cache, kernel；opens underrepresented target types |
| 7 | [[university/清华大学/Haojie Wang|Haojie Wang]] | person | project_contribution | project, community | exploration | 8.243 | new | coverage 0/3；source type Person；infra: serving/inference, kv-cache, kernel；opens underrepresented target types |
| 8 | [[company/趋境科技/艾智远 Zhiyuan Ai|艾智远]] | person | project_contribution | project, community | bridge | 8.137 | new | coverage 0/3；source type Person；infra: serving/inference, kv-cache, moe；opens underrepresented target types |
| 9 | [[university/清华大学/Kang Chen|陈康]] | person | project_contribution | project, community | bridge | 8.128 | new | coverage 0/3；source type Person；infra: serving/inference, kv-cache, distributed；opens underrepresented target types |
...
| 3 | [[community/FlashML-org/FreeToken/FreeToken|FreeToken]] | project | originating_org | 8.379 |
| 4 | [[community/MooreThreads/torch_musa/torch_musa|torch_musa]] | project | maintainers | 8.354 |
| 5 | [[community/MooreThreads/MATE/MATE|MATE]] | project | maintainers | 8.345 |
| 6 | [[community/Deep-Spark/lmcache-iluvatar/lmcache-iluvatar|lmcache-iluvatar]] | project | maintainers | 8.319 |
| 7 | [[community/MetaX-MACA/mcoplib/mcoplib|mcoplib]] | project | maintainers | 8.313 |
| 8 | [[community/sgl-project/mini-SGLang/mini-SGLang|mini-SGLang]] | project | originating_org | 8.218 |
| 9 | [[university/清华大学/Jinlei Jiang|蒋金磊]] | person | project_contribution | 8.097 |
| 10 | [[company/面壁智能/ForgeTrain|ForgeTrain]] | project | maintainers | 8.078 |
| 11 | [[company/面壁智能/MiniCPM|MiniCPM]] | project | maintainers | 8.078 |
