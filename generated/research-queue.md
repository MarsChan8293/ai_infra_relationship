...
| 5 | [[university/清华大学/Zan Zong|Zan Zong]] | person | project_contribution | project, community | exploration | 8.321 | new | coverage 0/3；source type Person；infra: serving/inference, scheduler, distributed；opens underrepresented target types |
...
| 7 | [[university/清华大学/Haojie Wang|Haojie Wang]] | person | project_contribution | project, community | exploration | 8.220 | new | coverage 0/3；source type Person；infra: serving/inference, kv-cache, kernel；opens underrepresented target types |
