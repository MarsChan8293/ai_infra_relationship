...
| 9 | [[community/vllm-project/vLLM/Michael Goin|Michael Goin]] | 31.720 | selective-dfs | 10.950 | 1.300 | 4.000 | - | bridge 10.9; infra: serving/inference, scheduler, kernel → typed person relations, hidden person chain |
| 10 | [[community/vllm-project/vLLM/Robert Shaw|Robert Shaw]] | 31.675 | selective-dfs | 10.922 | 1.300 | 4.000 | - | bridge 10.9; infra: serving/inference, kv-cache, kernel; multi-project 2 → typed person relations, hidden person chain |
| 11 | [[company/清程极智/翟季冬 Jidong Zhai|翟季冬]] | 31.530 | selective-dfs | 10.848 | 1.300 | 4.000 | - | bridge 10.8; infra: serving/inference, kv-cache, kernel; multi-project 3 → typed person relations, hidden person chain |
...
| 18 | [[community/vllm-project/vLLM/Nick Hill|Nick Hill]] | 29.522 | best-first | 10.409 | 1.300 | 3.550 | - | bridge 10.4; infra: serving/inference, kv-cache, scheduler → typed person relations |
...
| 22 | [[company/TensorMesh/程翊华 Yihua Cheng|程翊华]] | 28.821 | best-first | 11.107 | 1.300 | 2.700 | - | bridge 11.1; infra: serving/inference, kv-cache, distributed; multi-project 2 → typed person relations |
| 23 | [[company/深度求索/Shaoyuan Chen|Shaoyuan Chen]] | 28.705 | best-first | 9.770 | 1.300 | 3.450 | - | bridge 9.8; infra: serving/inference, kv-cache, distributed; multi-project 3 → typed person relations |
| 24 | [[community/llm-d/llm-d/Maroon Ayoub|Maroon Ayoub]] | 28.551 | best-first | 9.707 | 1.300 | 3.550 | - | bridge 9.7; infra: serving/inference, kv-cache, distributed; multi-project 5 → typed person relations |
| 25 | [[community/kvcache-ai/KTransformers/谢威宇 Weiyu Xie|谢威宇]] | 28.409 | best-first | 9.600 | 1.300 | 3.600 | - | bridge 9.6; infra: serving/inference, kv-cache, kernel → typed person relations |
| 26 | [[university/北京大学/吴童 Tong Wu|Tong Wu]] | 28.225 | best-first | 7.785 | 2.900 | 3.600 | - | bridge 7.8; gap 2.9; infra: serving/inference, kv-cache, kernel → project/community links, typed person relations, biographical/context depth |
...
| 32 | [[community/sgl-project/SGLang/Shenggui Li|Shenggui Li]] | 27.387 | best-first | 10.059 | 2.200 | 1.750 | - | bridge 10.1; gap 2.2; infra: serving/inference, distributed; multi-project 3 → current affiliation, typed person relations |
| 33 | [[community/flashinfer-ai/FlashInfer/叶子豪 Zihao Ye|叶子豪]] | 26.825 | best-first | 9.135 | 1.300 | 3.400 | - | bridge 9.1; infra: serving/inference, kernel, distributed → typed person relations |
| 34 | [[community/hpcaitech/Colossal-AI/Hongxin Liu|Hongxin Liu]] | 26.801 | best-first | 9.770 | 2.700 | 1.400 | - | bridge 9.8; gap 2.7; infra: distributed, quantization → current affiliation, typed person relations, biographical/context depth |
| 35 | [[community/ai-dynamo/Dynamo/Sungsoo Ha|Sungsoo Ha]] | 26.729 | best-first | 8.135 | 3.050 | 2.600 | - | bridge 8.1; gap 3.0; infra: serving/inference, distributed, disaggregation; multi-project 2 → typed person relations, technical areas, biographical/context depth |
| 36 | [[community/kvcache-ai/Mooncake/任峰 Feng Ren|任峰]] | 26.555 | best-first | 9.222 | 1.300 | 2.800 | - | bridge 9.2; infra: serving/inference, kv-cache, disaggregation → typed person relations |
| 37 | [[community/llm-d/llm-d/Danny Harnik|Danny Harnik]] | 26.547 | best-first | 8.522 | 1.300 | 3.550 | - | bridge 8.5; infra: serving/inference, kv-cache, distributed; multi-project 5 → typed person relations |
| 38 | [[community/llm-d/llm-d/Abdullah Gharaibeh|Abdullah Gharaibeh]] | 26.099 | best-first | 8.522 | 1.300 | 3.650 | - | bridge 8.5; infra: serving/inference, kv-cache, scheduler → typed person relations |
| 39 | [[company/OpenAI/柳晓萱 Xiaoxuan Liu|柳晓萱]] | 26.010 | best-first | 11.300 | 1.300 | 1.000 | - | bridge 11.3; infra: serving/inference → typed person relations |
| 40 | [[community/kvcache-ai/Mooncake/马腾 Teng Ma|马腾]] | 25.948 | best-first | 8.522 | 1.800 | 2.700 | - | bridge 8.5; infra: serving/inference, kv-cache, distributed; multi-project 3 → typed person relations, biographical/context depth |
| 41 | [[company/TensorMesh/Junchen Jiang|Junchen Jiang]] | 25.834 | best-first | 8.900 | 2.550 | 1.950 | - | bridge 8.9; gap 2.5; infra: serving/inference, kv-cache → typed person relations, technical areas, biographical/context depth |
| 42 | [[company/字节跳动/方佳瑞 Jiarui Fang|方佳瑞]] | 25.807 | best-first | 10.185 | 1.300 | 1.750 | - | bridge 10.2; infra: serving/inference, distributed → typed person relations |
| 43 | [[community/flashinfer-ai/FlashInfer/Jingfan Sun|Jingfan Sun]] | 25.756 | best-first | 8.720 | 1.300 | 3.400 | - | bridge 8.7; infra: serving/inference, kernel, distributed → typed person relations |
| 44 | [[company/硅基流动/袁进辉 Jinhui Yuan|袁进辉]] | 25.632 | best-first | 8.720 | 2.400 | 1.750 | - | bridge 8.7; gap 2.4; infra: serving/inference, distributed → project/community links, typed person relations |
