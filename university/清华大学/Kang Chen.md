...
schools:
  - "清华大学"
  - "北京大学"
areas: [distributed-systems, storage-systems, rdma, disaggregated-memory, graph-systems]
roles: [Systems Researcher]
confidence: verified
...
清华 MADSys / 高性能系统研究网络的重要系统研究者。MADSys 主页显示其 2026 年转至北京大学；此前长期在清华从事分布式存储、RDMA、NVM / disaggregated memory、图计算等研究。
...
## 图谱意义
陈康与武永卫共同构成清华传统 distributed/storage systems 人才培养网络的重要一支。这条路线向后连接了 Shuai Mu、Weichao Guo 等系统人才，并与 MADSys 后续的 disaggregated memory、KV cache / LLM serving 研究形成技术谱系上的连续性。
