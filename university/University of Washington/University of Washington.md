...
labs:
  - "SyFI Lab"
  - "SAMPL"
areas: [ai-infrastructure, machine-learning-systems, llm-serving, gpu-systems, compilers]
linked_people:
...
## AI Infra 关系
University of Washington 在本图谱中不只作为教育经历节点，还承载两条高价值 AI Infra 研究线：

- [[university/University of Washington/SyFI Lab|SyFI Lab]]：面向未来智能系统的 serving、distributed training、multimodal serving 与 agent-built systems。
- [[university/University of Washington/SAMPL|SAMPL]]：跨系统栈的 machine learning systems 协作组，覆盖 FlashInfer、Punica、Atom、SparseTIR、TVM 等项目。

两组存在人员和技术主题交叉，但本图谱不会因同校或共同论文自动推断所有成员之间存在直接合作。
...
- [[university/University of Washington/SyFI Lab/Stephanie Wang|Stephanie Wang]]：学术关联；具体属于访问、任职或研究等哪一类，以人物页公开来源为准。
